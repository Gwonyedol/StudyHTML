...
C:\FrontAndBackAnd\WebJSP\JSPLab\WebJSP\WebContent\Ex11_WebApp_RealPath.jsp

3. 웹(가상경로) -> 실 경로(물리적 경로) 반환해 주는 객ㅌ체
   request
   application
...
contextpath : C:\FrontAndBackAnd\WebJSP\JSPLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP

realpath : C:\FrontAndBackAnd\WebJSP\JSPLab\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
 -->    
<!DOCTYPE html>
<html>
<head>
